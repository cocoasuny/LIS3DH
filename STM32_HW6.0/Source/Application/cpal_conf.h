...
/* ÐÞ¸Ä */
#define _CPAL_TIMEOUT_INIT()     Clear_Timer_Cnt(gIICTIMID);\
								 Start_Timer_Cnt(gIICTIMID)
								 
#define _CPAL_TIMEOUT_DEINIT()   Stop_Timer_Cnt(gIICTIMID)

#ifndef CPAL_I2C_TIMEOUT_Manager
   void CPAL_I2C_TIMEOUT_Manager(Timer_ID_Typedef TIMID);
#else
