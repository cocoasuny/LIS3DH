...
bma2x2_t * p_bma2x2;
unsigned char V_BMA2x2RESOLUTION_U8R = 1; /* Based on Bit resolution value should be modified */
...
int bma2x2_init(bma2x2_t *bma2x2)
{
    ...
    p_bma2x2->bus_read = BMA250E_SPI_Read;
    p_bma2x2->bus_write = BMA250E_SPI_Write;
